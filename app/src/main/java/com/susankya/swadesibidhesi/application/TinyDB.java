...
public class TinyDB {
    ...
    public ArrayList<WcBilling> getBillingAddressList(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<WcBilling> billingList =  new ArrayList<WcBilling>();

        for(String jObjString : objStrings){
            WcBilling billing  = gson.fromJson(jObjString,  WcBilling.class);
            billingList.add(billing);
        }
        return billingList;
    }

    public ArrayList<WcOrderItem> getOrderLists(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<WcOrderItem> billingList =  new ArrayList<WcOrderItem>();

        for(String jObjString : objStrings){
            WcOrderItem billing  = gson.fromJson(jObjString,  WcOrderItem.class);
            billingList.add(billing);
        }
        return billingList;
    }

    public ArrayList<WcProduct> getListCartItem(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<WcProduct> productList =  new ArrayList<WcProduct>();

        for(String jObjString : objStrings){
            WcProduct product  = gson.fromJson(jObjString,  WcProduct.class);
    ...
    public void putListBillingAddresses(String key, List<WcBilling> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(WcBilling obj : objArray){
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }

    public void putListOrders(String key, List<WcOrderItem> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(WcOrderItem obj : objArray){
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }

    public void putListCartItems(String key, ArrayList<WcProduct> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(WcProduct obj : objArray){
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }
