package com.susankya.swadesibidhesi.Task;
...
import static com.susankya.swadesibidhesi.Config.Constant.BASIC_AUTH;
        ...
        for (int i = 0; i < urls.length; i++) {
            ...
            try {
                switch (mMethod){
                    case METHOD_POST:
                    case METHOD_PUT:
                        RequestBody body1 = RequestBody.create(JSON, mRequestBody);
